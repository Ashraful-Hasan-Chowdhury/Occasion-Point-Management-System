...
<head>
    ...
    <title>OPMS Photographer Registration</title>
...
<body class="animsition page-register layout-full page-dark">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
        <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
            ...
            <form method="post" role="form" action="{{ route('photographer.register') }}">
                @csrf
            ...
            <p>or</p>
            <a class="btn btn-primary btn-block" href="{{ route('photographer.login') }}">
                Sign In
            </a>
        </div>
    </div>
