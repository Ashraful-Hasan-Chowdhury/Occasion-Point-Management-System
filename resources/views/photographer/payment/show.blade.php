...
<div class="page">
    <div class="page-header page-header-bordered" style="background:#9400D3;">
        ...
        <h1 class="page-title" style="color:white;">Photographer's Payment</h1>
        <ol class="breadcrumb">
        ...
        <div class="panel">
            <header class="panel-heading">
                ...
                <div class="panel-actions">
                    <h4 style="color: #784212;">Total Due: {{auth('photographer')->user()->due}} BDT</h4>
                </div>
                <h3 class="panel-title">Payment History
                    <a href="{{ route('photographer.payment.add') }}"
