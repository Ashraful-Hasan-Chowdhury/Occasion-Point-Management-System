...
<div class="page">
    <div class="page-header page-header-bordered" style="background: #CD6155;">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('parlour.package.edit',$package->id) }}" style="color:white;">
                    Edit Package</a></li>
        </ol>
    </div>
        ...
        <div class="panel">
            <header class="panel-heading">
                ...
                <div class="panel-actions">
                    <a href="{{ route('parlour.package') }}" class="btn btn-md-block btn-warning text-light"
            ...
            <div class="panel-body container-fluid">
                <form autocomplete="off" action="{{ route('parlour.package.update',$package->id) }}" method="post"
