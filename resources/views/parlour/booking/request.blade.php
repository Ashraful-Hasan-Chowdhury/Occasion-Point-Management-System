...
<div class="page">
    <div class="page-header page-header-bordered" style="background: #CD6155;">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('parlour.booking.request') }}" style="color:white;">Booking
                    Request</a>
            </li>
        </ol>
    </div>
        ...
        <div class="panel">
            <header class="panel-heading">
                ...
                <h3 class="panel-title">Booking Request
                    <a href="{{ route('parlour.booking') }}" class="btn btn-md-block btn-success offset-4 text-light"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="{{ route('parlour.booking.accept', ['id'=>$booking->id]) }}"
                                            class="btn btn-md  btn-info">
                                            <i class="icon wb-check"></i>
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="{{ route('parlour.booking.reject', ['id'=>$booking->id]) }}"
