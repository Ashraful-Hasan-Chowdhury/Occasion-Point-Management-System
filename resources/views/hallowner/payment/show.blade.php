...
<div class="page">
    <div class="page-header page-header-bordered" style="background:#007bff;">
        ...
        <h1 class="page-title" style="color:white;">Hall's Payment</h1>
        <ol class="breadcrumb">
        ...
        <div class="panel">
            <header class="panel-heading">
                ...
                <div class="panel-actions">
                    <h4 style="color: #784212;">Total Due: {{auth('hallowner')->user()->due}} BDT</h4>
                </div>
                <h3 class="panel-title">Payment History
                    <a href="{{ route('hallowner.payment.add') }}"
