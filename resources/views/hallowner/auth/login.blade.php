...
<head>
    ...
    <title>OPMS Hall Owner Login</title>
    ...
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('public/admin/assets/examples/css/pages/login.min599c.css?v4.0.2')}}">
    ...
    <!-- Scripts -->
    <script src="{{asset('public/global/vendor/breakpoints/breakpoints.min599c.js?v4.0.2')}}"></script>
    <script>
        Breakpoints();
    </script>
</head>
...
<body class="animsition page-login layout-full page-dark">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
        <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
            ...
            <p>Hall Owner Login</p>
            <form method="post" action="{{ route('hallowner.login') }}">
                @csrf
            ...
            <p>or</p>
            <a class="btn btn-primary btn-block" href="{{ route('hallowner.register') }}">
