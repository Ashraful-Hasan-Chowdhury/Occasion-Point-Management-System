            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading">
                        <h2 class="title"> Available Halls in {{$date}} </h2>
                    </div>
...
<div class="site-main">
            ...
            <div class="row">
                <div class="col-lg-9 content-area">
                    ...
                    <div class="row">
                        ...
                        @endif
                        @endif
                        @if ($owner->block == "false" && $owner->approve == "approved")
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="product-thumbnail">
                                    ...
                                    @endif
                                    <img class="img-fluid w-100" src="{{asset($hall->image)}}" alt=""
                                        style="height: 275px;">
                                    <div class="ttm-shop-icon">
                                        <!-- ttm-shop-icon -->
                                        <div class="product-btn add-to-cart-btn"><a
                                                href="{{ route('hall.details', ['id'=>$hall->id]) }}">View Details</a>
                                        </div>
                                    </div>
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-title">
                                        <!-- product-title -->
                                        <h2><a href="{{ route('hall.details', ['id'=>$hall->id]) }}">{{$hall->name}}</a>
                                        </h2>
                                    </div>
    ...
    <div class="col-lg-3 widget-area sidebar-right widget_border">
        <aside class="widget  with-title">
            <form role="search" method="get" action="{{ route('hall.date') }}" id="searchForm">
                @csrf
