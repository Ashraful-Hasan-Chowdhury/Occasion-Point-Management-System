            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading">
                        <h2 class="title"> Parlour Details </h2>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="ttm-single-product-details">
                            ...
                            <div class="product-gallery images">
                                <figure class="ttm-product-gallery__wrapper">
                                    <div class="product-gallery__image">
                                        <img class="img-fluid" src="{{asset($parlour->parlourimage)}}" alt="product-img"
                                            style="width: 367px;height: 429px;">
                                    </div>
                                </figure>
                            </div>
                            <div class="summary entry-summary">
                                <h3 class="singel_product_title">{{$parlour->parlourname}}</h3>
                                ...
                                <p class="price">
                                    <span class="Price-amount amount">
                                        <ins><span class="product-Price-amount">
                                                <span
                                                    class="product-Price-currencySymbol"></span>{{$parlour->packages()->count()}}
                                                Packages
                                            </span>
                                        </ins>
                                ...
                                <div class="product_meta">
                                    <div class="sku_wrapper">
                                        <span>Address: </span>
                                        <a href="#" rel="tag">{!!htmlspecialchars_decode($parlour->address)!!}</a>
                                    </div>
                                    <span class="posted_in">Packages & Price:
                                        @foreach ($parlour->packages as $package)
                                        <h5>
                        ...
                        <div class="ttm-tabs tabs-for-single-products" data-effect="fadeIn">
                            <ul class="tabs clearfix">
                                ...
                                <li class="tab"><a href="#">Reviews ({{$parlour->reviews()->count()}})</a></li>
                            </ul>
                            <div class="content-tab ttm-bgcolor-white">
                                ...
                                <div class="content-inner">
                                    <div id="reviews" class="woocommerce-Reviews">
                                        <div id="comments">
                                            <h2 class="woocommerce-Reviews-title">{{$parlour->reviews()->count()}}
                                                review
                                                for {{$parlour->parlourname}}</h2>
                                            <ol class="commentlist">
                                                {{-- Review Start --}}
                                                @foreach ($parlour->reviews as $review)
                                                <li class="review">
                                        ...
                                        <div id="review_form_wrapper">
                                            <div class="comment-respond">
                                                ...
                                                <form action="{{ route('review.store.parlour',$parlour->id) }}"
                ...
                <div class="col-lg-3 widget-area sidebar-right widget_border">
                    <aside class="widget with-title">
                        ...
                        <form role="search" method="post" action="{{ route('parlour.book',$parlour->id) }}"
                            id="searchForm">
                            @csrf
                            ...
                            @if ($parlour->discount == "true")
                            <input type="hidden" name="bookingamount" value="{{$parlour->discount_amount}}">
                            @else
                            <input type="hidden" name="bookingamount" value="{{$parlour->amount}}">
                            @endif
